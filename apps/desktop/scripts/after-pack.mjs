 ...
 *
 * Stamps the Mousai Workspace icon + identity onto the packed Windows app via
 ...
 *   - packager.appInfo.productFilename: the internal exe basename (currently 'Hermes')
 */
...
export default async function afterPack(context) {
  ...
  try {
    ...
    console.warn(`[after-pack] exe identity stamp failed (${err.message}); the app keeps the stock Electron icon`)
  }
}
